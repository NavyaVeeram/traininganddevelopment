...
//         <td className="border px-4 py-2">Boomlift Training</td>
//       </tr>
//     ))}
//       <tr>
...
//         <td className="border px-4 py-2">E0019</td>
//       </tr>
//       <tr>
//         <td className="border px-4 py-2 font-semibold">Designation</td>
//         <td className="border px-4 py-2">HR Manager</td>
//         <td className="border px-4 py-2 font-semibold">Mode of Training</td>
//         <td className="border px-4 py-2">Internal/External/Overseas ✅</td>
//       </tr>
//       <tr>
//         <td className="border px-4 py-2 font-semibold">Section</td>
//         <td className="border px-4 py-2">Recruitment</td>
