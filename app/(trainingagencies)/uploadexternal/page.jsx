...
const TrainingAgencies = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-sm space-y-6">
      {/* Header */}
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mx-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div key="Mailid" className="mb-4 relative">
            ...
            <div className="relative">
              <Input
                ...
                className="w-full px-1 py-1 pr-20 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
          ...
          <div className="col-span-full sm:col-span-2 lg:col-span-4 flex justify-end">
            <Button className="bg-blue-500 hover:bg-blue-300 text-white w-full sm:w-auto">
              Submit
            </Button>
          </div>
        </div>
