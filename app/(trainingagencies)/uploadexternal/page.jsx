...
const Upload = () => {
  ...
  return (
    <div className="max-w-full mx-auto bg-white p-4 shadow-md rounded-lg w-full">
      {/* Header */}
      <div className="bg-sky-600 text-white p-2 rounded-t-lg flex  items-center">
...
<div className="mt-2">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="col-span-full sm:col-span-2 lg:col-span-4 flex justify-end">
            <Button     className="px-6 py-2 text-sm font-semibold text-white bg-gray-600 rounded-md shadow-md hover:bg-gray-300 focus:ring-2 focus:ring-black-600 focus:ring-offset-2">
              Submit
            </Button>
          </div>
        </div>
