...
import ScrollableYearPicker from "./YearPicker" 
import { ChartContainer } from "@/components/ui/chart";
import { GiArrowScope } from "react-icons/gi";
import WeeklyTrainingComponent from "./WeeeklyTrainingComponent"
        ...
        <div className="flex mb-8">
          <div className="bg-gradient-to-r from-blue-400 to-green-400 shadow rounded-lg p-4 flex items-left gap-3 border">
            <div className="relative inline-block">
              <button
                className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-100"
