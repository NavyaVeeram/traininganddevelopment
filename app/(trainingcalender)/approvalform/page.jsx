...
import FullYearCalendar from "../../fullYearCalender/page";
  ...
  const handleUpdate = async () => {
    try {
      ...
      const res = await fetch(
        `/api/update_training_data_approval?Program_Id=${programId}`,
        {
          method: "POST",
              ...
              >
                ...
                <tbody>
                  {paginatedData.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan={Object.keys(columnKeyMap).length + 1}
                  ...
                  <div>
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="px-4 py-2 text-sm font-semibold text-white bg-green-600 hover:bg-green-900  rounded-md mr-2 mt-2 cursor-pointer"
                      >
                        Update
                      </button>
                      <button
                        onClick={handleCancel}
                        className="px-4 py-2 text-sm font-semibold text-white bg-red-600 hover:bg-red-900  rounded-md mt-2 cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
