  ...
  return (
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-r bg-gray-50 text-white" style={{margin:0,padding:0}}>
      <form onSubmit={handleSubmit} className="w-full max-w-2xl p-8 bg-white rounded-lg shadow-lg space-y-8 transform transition-all duration-300 ease-in-out hover:scale-100">
        <h2 className="bg-sky-600 text-white p-4 rounded-t-lg">
          Program Request Form
        </h2>
        <div className="flex flex-col">
          {/* Training Mode */}
          <div className="space-y-1">
            <label htmlFor="Training_Name" className="block text-sm font-medium text-gray-600">
              Mode of the Program
            </label>
          ...
          {/* Program Name */}
          <div className="space-y-1">
            <label htmlFor="Program_Name" className="block text-sm font-medium text-gray-600">
              Name of the Program
            </label>
            <textarea 
            type="text"
        ...
        <div className="flex justify-between gap-x-6">
          <button
            type="submit"
            className="px-6 py-2 text-lg font-semibold text-white bg-gray-600 rounded-md shadow-md hover:bg-gray-500 focus:ring-2 focus:ring-g-600 focus:ring-offset-2 transform transition duration-200 hover:scale-105"
          >
            Save
          </button>
          <button
